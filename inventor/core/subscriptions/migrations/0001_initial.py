# Generated by Django 2.2.4 on 2020-09-03 10:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, db_index=True, decimal_places=2, default=None, help_text=None, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='price')),
                ('period', models.PositiveIntegerField(blank=True, db_index=True, default=30, help_text='days', null=True, verbose_name='period')),
