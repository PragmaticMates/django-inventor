# Generated by Django 2.2.4 on 2020-09-23 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricing', models.ForeignKey(blank=True, default=None, help_text='pricing', null=True, on_delete=django.db.models.deletion.CASCADE, to='subscriptions.Pricing')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user', related_name='subscription', related_query_name='subscription')),
            ],
            options={
