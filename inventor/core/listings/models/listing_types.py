...
from inventor.core.utils.helpers import is_listing_type_enabled
...
if is_listing_type_enabled('Property'):
...
if is_listing_type_enabled('EatAndDrink'):
...
if is_listing_type_enabled('Service'):
...
if is_listing_type_enabled('Vacation'):
...
if is_listing_type_enabled('Activity'):
...
if is_listing_type_enabled('Race'):
    class Race(Listing):
        section = _('sport')
...
if is_listing_type_enabled('Training'):
...
if is_listing_type_enabled('Exercise'):
...
if is_listing_type_enabled('Trip'):
    class Trip(Listing):
        section = _('tourism')
        distance = models.PositiveSmallIntegerField(_('distance'), help_text='km', blank=True, null=True, default=None)
...
if is_listing_type_enabled('Event'):
    class Event(Listing):
        section = _('events')
...
if is_listing_type_enabled('Shop'):
...
if is_listing_type_enabled('Vehicle'):
...
if is_listing_type_enabled('Profile'):
...
if is_listing_type_enabled('Job'):
    class Job(Listing):
        section = _('work')
...
if is_listing_type_enabled('Course'):
...
if is_listing_type_enabled('Nature'):
