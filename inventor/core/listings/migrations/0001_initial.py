    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_unit', models.CharField(blank=True, choices=[('ENTRY', 'entry'), ('HOUR', 'hour'), ('DAY', 'day'), ('NIGHT', 'night')], max_length=5, verbose_name='price unit')),
                ...
                ('locality', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='lexicons.Locality')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('listing_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='listings.Listing')),
                ('booking_enabled', models.BooleanField(default=True, verbose_name='bookings enabled')),
                ('booking_url', models.URLField(blank=True, max_length=300, verbose_name='booking URL')),
                ...
                ('booking_min_period', models.SmallIntegerField(blank=True, default=None, null=True, verbose_name='min period')),
                ('booking_max_period', models.SmallIntegerField(blank=True, default=None, null=True, verbose_name='max period')),
                ('booking_min_persons', models.SmallIntegerField(blank=True, default=None, null=True, verbose_name='min persons')),
